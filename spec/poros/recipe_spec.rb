...
RSpec.describe Recipe do
  it "exists" do 
    ...
    attrs = {
      id: nil,
      type: "recipe", #[:hits][0]]
      label: "Ethiopia Coffee Pancakes With Blueberry Maple Syrup recipes", #[:recipe][:label]
      url: "http://dadwithapan.com/recipe/ethiopia-coffee-pancakes-with-blueberry-maple-syrup/", #[:recipe][:url]
      country: q, #q?? [:recipe][:tags] = Ethiopian? why is this here?? "ethiopia"??
